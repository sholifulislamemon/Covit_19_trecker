...
Worldcovidattacktmodel worldCovidAttacktModelFromJson(String str) => Worldcovidattacktmodel.fromJson(json.decode(str));
String worldCovidAttacktModelToJson(Worldcovidattacktmodel data) => json.encode(data.toJson());
class Worldcovidattacktmodel {
  Worldcovidattacktmodel({
      num? updated, 
      num? cases, 
      num? todayCases, 
      num? deaths, 
  ...
  Worldcovidattacktmodel.fromJson(dynamic json) {
...
Worldcovidattacktmodel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => Worldcovidattacktmodel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
